...
_KEY_POSITIONS: dict[str, tuple[float, float]] = {
    ...
    'MEDIA_PREV': (0.62, 0.00), 'PLAY_PAUSE': (0.67, 0.00),
    'MEDIA_NEXT': (0.72, 0.00), 'MUTE': (0.77, 0.00),
    'ESC':  (0.04, 0.14),
    'F1':  (0.10, 0.14), 'F2':  (0.14, 0.14), 'F3':  (0.18, 0.14), 'F4':  (0.22, 0.14),
    'F5':  (0.27, 0.14), 'F6':  (0.31, 0.14), 'F7':  (0.35, 0.14), 'F8':  (0.39, 0.14),
    'F9':  (0.44, 0.14), 'F10': (0.48, 0.14), 'F11': (0.52, 0.14), 'F12': (0.56, 0.14),
    'PRINT_SCREEN': (0.61, 0.14), 'SCROLL_LOCK': (0.65, 0.14), 'PAUSE': (0.68, 0.14),
    'ILLUMINATION': (0.73, 0.14),
    'BACKTICK': (0.04, 0.28),
